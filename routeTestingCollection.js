...
async function start() {
    ...
    mongoose
      ...
      .then((x) => {
        ...
        // OTHER TIME FRAMES FOR 1 HOUR, 12 HOUR, 24 HOUR, 7 DAY
    
        // function thirtyTransactionsCollection() {
        //     // let currentTimestamp = Math.floor(Date.now()/1000)
        //     let currentTimestamp = 1677958278
        //     const date = new Date(currentTimestamp * 1000); // Convert Unix timestamp to JavaScript Date object
        //     const minutes = date.getMinutes();
        ...
        //     Transaction.find({transactionTimeStamp: {$gte: passThirty ,$lt: roundedThirty}})
        //     .sort({transactionTimeStamp: -1})
        //     .then((foundTrans) => {
        //         foundTrans.forEach((tran) => {
        //             newArr.push(tran.transactionTimeStamp);
        //         })
        //         console.log(newArr);
