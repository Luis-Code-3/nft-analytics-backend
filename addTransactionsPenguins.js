...
const collectionAddy = '0xbd3531da5cf5857e7cfaa92426877b022e612cf8';
const tokenTransfersCollection = `https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0xbd3531da5cf5857e7cfaa92426877b022e612cf8&page=1&offset=2&startblock=0&endblock=99999999&sort=desc&apikey=${key}`;


async function PudgyPenguins () {
    
    let sortedArray = [];
    let recentTransactionBlock = '';

    await Collection.findOne({ nftName: "Pudgy Penguin"})
    ...
    const findNftTransactions = async () => {
        const transfers = await axios.get(`https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0xbd3531da5cf5857e7cfaa92426877b022e612cf8&page=1&offset=2&startblock=${recentTransactionBlock}&endblock=99999999&sort=desc&apikey=${key}`);
    ...
    await Collection.findOneAndUpdate({ nftName: "Pudgy Penguin"}, {
