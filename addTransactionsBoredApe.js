...
const collectionAddy = '0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d';
const tokenTransfersCollection = `https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d&page=1&offset=100&startblock=0&endblock=99999999&sort=desc&apikey=${key}`;


async function BoredApe (currentEthereumPrice) {
    
    let sortedArray = [];
    let recentTransactionBlock = '';

    await Collection.findOne({ nftName: "Bored Ape"})
    ...
    const findNftTransactions = async () => {
        const transfers = await axios.get(`https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d&page=1&offset=10000&startblock=${recentTransactionBlock}&endblock=99999999&sort=desc&apikey=${key}`);
    ...
    await Collection.findOneAndUpdate({ nftName: "Bored Ape"}, {
