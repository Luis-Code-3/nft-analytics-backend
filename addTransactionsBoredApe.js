...
async function BoredApe (currentEthereumPrice) {
    ...
    const findNftTransactions = async () => {
        const transfers = await axios.get(`https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d&page=1&offset=100&startblock=${recentTransactionBlock}&endblock=99999999&sort=desc&apikey=${key}`);
