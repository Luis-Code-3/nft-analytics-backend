...
const collectionAddy = '0x1a92f7381b9f03921564a437210bb9396471050c';
const tokenTransfersCollection = `https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0x1a92f7381b9f03921564a437210bb9396471050c&page=1&offset=10000&startblock=0&endblock=99999999&sort=desc&apikey=${key}`;


async function CoolCats (currentEthereumPrice) {
    
    let sortedArray = [];
    let recentTransactionBlock = '';

    await Collection.findOne({ nftName: "Cool Cat"})
    ...
    const findNftTransactions = async () => {
        const transfers = await axios.get(`https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0x1a92f7381b9f03921564a437210bb9396471050c&page=1&offset=10000&startblock=${recentTransactionBlock}&endblock=99999999&sort=desc&apikey=${key}`);
    ...
    await Collection.findOneAndUpdate({ nftName: "Cool Cat"}, {
