...
const tokenTransfersCollection = `https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0x1a92f7381b9f03921564a437210bb9396471050c&page=1&offset=100&startblock=0&endblock=99999999&sort=desc&apikey=${key}`;
...
async function CoolCats (currentEthereumPrice) {
    ...
    const findNftTransactions = async () => {
        const transfers = await axios.get(`https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0x1a92f7381b9f03921564a437210bb9396471050c&page=1&offset=100&startblock=${recentTransactionBlock}&endblock=99999999&sort=desc&apikey=${key}`);
