...
const tokenTransfersCollection = `https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0x3bf2922f4520a8ba0c2efc3d2a1539678dad5e9d&page=1&offset=2&startblock=0&endblock=99999999&sort=desc&apikey=${key}`;
...
async function OnForce () {
    ...
    const findNftTransactions = async () => {
        const transfers = await axios.get(`https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0x3bf2922f4520a8ba0c2efc3d2a1539678dad5e9d&page=1&offset=2&startblock=${recentTransactionBlock}&endblock=99999999&sort=desc&apikey=${key}`);
