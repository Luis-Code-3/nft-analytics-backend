...
async function Azuki (currentEthereumPrice) {
    ...
    await Collection.findOne({ nftName: "Azuki"})
    ...
    const findNftTransactions = async () => {
        const transfers = await axios.get(`https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0xed5af388653567af2f388e6224dc7c4b3241c544&page=1&offset=10000&startblock=${recentTransactionBlock}&endblock=99999999&sort=desc&apikey=${key}`);
    ...
    await Collection.findOneAndUpdate({ nftName: "Azuki"}, {
